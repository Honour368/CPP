...
vector<int> maxmin(vector<int>& num) //passing vectors in by reference.
{
...
int main()
{
  ...
  srand ((int) time(0));   //  initialize random seed, without this statement, the random number generated will be the same everytime you run the code
